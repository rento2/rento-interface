...
(() => {
  ...
  // Сессия команды (после выбора сотрудника) живёт 24 часа и
  ...
  function showLogin(errorText) {
    ...
    Screens.login({
      ...
      onSubmit: (userId) => {
        ...
        startUserSession();           // 24 часа с момента входа
        showMain();
        return null;
      },
      onSwitchAccount: () => {
  ...
  async function startSession(token) {
    ...
    try {
      ...
      // Сессия команды живёт 24 часа и переживает F5: если у нас уже
